...
namespace FudbalskiTurnirWeb.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(FudbalskiTurnirWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Team != null ? 
                          ...
                          Problem("Entity set 'FudbalskiTurnirWebContext.Team'  is null.");
        }
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id,CreatedAt,UpdatedAt,DeletedAt,IsDeleted,IsActive")] Team team)
        {
            if (id != team.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FudbalskiTurnirWebContext.Team'  is null.");
            }
            var team = await _context.Team.FindAsync(id);
            if (team != null)
            {
